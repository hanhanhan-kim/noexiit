...
def main():
    ...
    stream_to_csv(csv_path, 
                  duration_s=duration,
                  input_channels=[7, 193, 210, 224], # 7 is an FIO, and so will be LOW voltage on U3-HV
                  input_channel_names={7: "PID (V)", 193: "digi_valves", 210: "DAQ count", 224: "16-bit roll-overs"},
                  times="absolute",
